  ...
  return {
    messages: [
      ...
      },
      {
        ...
        Instead negatively decline.
        `,
      },
      {
        role: "assistant",
        content:
          "Ok, I will ONLY answer questions and requests related to Cool Air solutions. I will negatively decline to answer all others.",
      },
      ...
      },
      {
        role: "assistant",
        content:
          "My name is Chilly and I am a AI Support bot for CoolAir Solutions",
      },
      {
        role: "user",
